    ...
    <div class="container">
        <div class="box form-box">
            ...
            if(isset($_POST['submit'])){
                ...
                $verify_unique=mysqli_query($con,"select Email from admin_data where Email='$email'");
                if(mysqli_num_rows($verify_unique)!=0)
                {
                    ...
                    mysqli_query($con,"INSERT INTO admin_data(Id,Name,Email,Password) VALUES('$rollno','$name','$email','$password')");
                    echo "<div class='message'>
